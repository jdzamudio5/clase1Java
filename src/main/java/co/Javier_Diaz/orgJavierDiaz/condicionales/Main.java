<<<<<<<< HEAD:src/main/java/co/rafael/condicionales/Main.java
package co.rafael.condicionales;
========
...
>>>>>>>> develop:src/main/java/co/Javier_Diaz/orgJavierDiaz/condicionales/Main.java
/*
 * @(#) Main.java 11.0
